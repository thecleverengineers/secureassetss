...
const landlordMenu = ['dashboard', 'subscription', 'property-management', 'properties', 'property-spaces', 'property-media', 'applications', 'tenant-interviews', 'property-visits', 'tenancies', 'rental-invoices', 'utility-readings', 'reminder-rules', 'property-promotions', 'tenant-profiles', 'occupants', 'leases', 'payments', 'complaints', 'facilities', 'facility-bookings', 'documents', 'messages', 'notifications', 'profile'];
